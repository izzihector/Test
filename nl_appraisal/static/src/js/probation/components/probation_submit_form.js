    ...
    methods: {
        writeDataToForm(data) {
            ...
            if(this.currentState == 'objective_setting') {
                ...
                this.note = "By validating and submitting these objectives, the appraisal will move to the 'Probation Period' stage - and the employee shall have access to review these objectives from his portal. Furthermore, you shall still be able to make necessary changes during the probation period if required."
            } 
            else if(this.currentState == 'supervisor_assessment') {
                this.confirmationRequired = false
                this.buttonText = "Sign and Finalize"
                this.note = "By choosing to click on the 'Sign' buttons above, you hereby confirm that you have provided your feedback and comments with regards to this appraisal to the best of your knowledge. This confirmation, along with the date and time of your confirmation, will be logged by the system as your electronic signature for this document."
            }
            else if (this.currentState == 'self_assessment') {
                this.confirmationRequired = false
                this.note = "By validating and submitting, the appraisal will move to the 'Supervisor Assessment' stage."
            }

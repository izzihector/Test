ECareerAspiration = {
    ...
    methods: {
        ...
        writeDataToForm(data) {
            ...
            this.formData['has_emp_career_aspiration'] = true
            this.formData['p4_emp_feed1'] = data.value['p4_emp_feed1']
            this.formData['p4_emp_feed2'] = data.value['p4_emp_feed2']
            this.formData['p4_emp_feed3'] = data.value['p4_emp_feed3']
            this.formData['p4_emp_feed4'] = data.value['p4_emp_feed4']
            this.formData['p4_emp_comments'] = data.value['p4_emp_comments']
        },
        async submitForm() {
            ...
            if (result) {
                ...
                if (this.appraisalData.value.metaInfo.employee_career_aspiration_state){
                    this.changeComponent('EUpwardFeedback')
                }
            } 
  ...
  template: `
        <div>
        <h4 style="font-size: 20px;background: #ffffff;padding: 10px 0;margin-top: 20px;border-bottom: 4px solid #875a7b;text-transform: uppercase;">Employee Learning, Development and Career aspirations
        </h4>
        ...
        This section summarizes the Learning and Development iniviatives (formal trainings, projects and assignments, etc) during the year, as was with regards to the invidual career path and aspirations of the employee.</p></legend>
            <div class="py-1">
                <form class="form-group" @submit.prevent="submitForm">
                    ...
                    <div class="questions">
                        ...
                        Did you receive any formal training sponsored by SCA/Donor or stakeholder during the review period?
                        </p>
                        <span class="objective-title">Employee Answer</span>
                        <div class="question-feedback">
                            <textarea class="form-control question-feedback-textarea" rows="5" placeholder="Provide your comments here ..." :disabled="readOnlyMode" 
                                v-model="formData.p4_emp_feed1" name="p3_q4 p4_emp_feed1" id="p3_q4 p4_emp_feed1"></textarea>
                        </div>
                    </div>
                    <div class="questions">
                        <span class="objective-title">Question 2.</span>
                        <p class="question-text">
                        How has the training impacted on your work and SCA mission and objectives?
                        </p>
                        <span class="objective-title">Employee Answer</span>
                        <div class="question-feedback">
                            <textarea class="form-control question-feedback-textarea" rows="5" placeholder="Provide your comments here ..." :disabled="readOnlyMode" 
                            v-model="formData.p4_emp_feed2" name="p3_q4 p4_emp_feed2" id="p3_q4 p4_emp_feed2"></textarea>
                        </div>
                    </div>
                    <div class="questions">
                        <span class="objective-title">Question 3.</span>
                        <p class="question-text">
                        Where you involved in any assignments within your department/ unit? (out of your day-to-day work) such as Leading on a project, or any other assignment that improved your skills, competencies and confidence.
                        </p>
                        <span class="objective-title">Employee Answer</span>
                        <div class="question-feedback">
                            <textarea class="form-control question-feedback-textarea" rows="5" placeholder="Provide your comments here ..." :disabled="readOnlyMode" 
                                v-model="formData.p4_emp_feed3" name="p3_q4 p4_emp_feed3" id="p3_q4 p4_emp_feed3"></textarea>
                        </div>
                    </div>
                    <div class="questions">
                        <span class="objective-title">Question 4.</span>
                        <p class="question-text">
                        Do you think you are on the right career path in SCA? What are your career aspirations based on your skills, experience and current role in SCA?
                        </p>
                        <span class="objective-title">Employee Answer</span>
                        <div class="question-feedback">
                            <textarea class="form-control question-feedback-textarea" rows="5" placeholder="Provide your comments here ..." :disabled="readOnlyMode" 
                                v-model="formData.p4_emp_feed4" name="p3_q4 p4_emp_feed4" id="p3_q4 p4_emp_feed4"></textarea>
                        </div>
                    </div>
                    <div class="questions">
                        <span class="objective-title">Question 5.</span>
                        <p class="question-text">
                        Do you have any other feedback with regards to your learning, development and career aspirations?
                        </p>
                        <span class="objective-title">Employee Answer</span>
                        <div class="question-feedback">
                            <textarea class="form-control question-feedback-textarea" rows="5" placeholder="Provide your comments here..." :disabled="readOnlyMode" 
                                v-model="formData.p4_emp_comments" name="p3_q4 p4_emp_comments" id="p3_q4 p4_emp_comments"></textarea>
                        </div>
                    </div>
                </form>
            </div>    

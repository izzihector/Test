FieldSubmitForm = {
    ...
    methods: {
        writeDataToForm(data) {
            ...
            this.nextStageDispaly =  this.appraisalData.value.all_states[this.nextStage]
            ...
            if (this.currentState == 'supervisor_review') {
                ...
                this.note = "by clicking on 'Submit', you hereby verify that the evaluation you have provided is accurate and to the best of your knowledge. The appraisee will be able to access and review his evaluation. This is an electronic confirmation and no signatures will be required"
            }
    ...
    template: `
        <div class="text-center">
            ...
            <button class="btn btn-secondary btn-odoo bt-sm mt-3" @click="submitForm(1)" v-if="appraisalData.value.metaInfo.setSubmitAccess" :disabled="disableButton">{{ buttonText }}</button>
        </div>
    `
}
...
FieldMPerformanceRating = {
    ...
    methods: {
        ...
        writeDataToForm(data) {
            ...
            this.formData['has_sup_field_performance_rating'] = true
            // if (!data.value['p7_overall_rating'] && !data.value['p7_overall_rating_not_applicable'] && data.value['field_p1_total_score']) {
            //     this.formData['p7_overall_rating'] = data.value['field_p1_total_score']
            // } else if (data.value['p7_overall_rating_not_applicable']) {
            //     this.formData['p7_overall_rating'] = ''
            // } else {
            //     this.formData['p7_overall_rating'] = data.value['p7_overall_rating']
            // }
            this.formData['p7_overall_rating'] = data.value['p7_overall_rating']
            this.formData['p7_overall_rating_not_applicable'] = data.value['p7_overall_rating_not_applicable']
        ...
        async submitForm() {
            ...
            if (result) {
                ...
                if (this.appraisalData.value.metaInfo.field_staff_overall_rating_state){
                    this.changeComponent('FieldMOverAllAssessment')
                }
            }
    ...
    template: `
        <div>
            <h4 style="font-size: 20px;background: #ffffff;padding: 10px 0;margin-top: 20px;border-bottom: 4px solid #875a7b;text-transform: uppercase;">
                Line Supervisor and overall performance rating and way forward
            </h4>
                    ...
                    <div class="row">
                        <div class="col-lg-9 p-0">
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">4.5 – 5</div>
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Exceptional/Outstanding</div>
                            </div>
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">3.5 – 4.4</div>
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Exceeds Expected Performance</div>
                            </div>
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">2.5 – 3.4</div>
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Meets Expected Performance</div>
                            </div>
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">1.5 – 2.4 </div>
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Required performance improvement</div>
                            </div>
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">1 – 1.4 </div>
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Unsatisfactory/Unacceptable Performance</div>
                            </div>
                            <div class="row bg-white">
                                <div class="col-lg-4 border-grey border py-1 px-2 odoo-cell-grey">
                                    Not Applicable
                                ...
                                <div class="col-lg-8 border-grey border py-1 px-2 odoo-cell-grey">Not Applicable or Not Able to Evaluate</div>
                            </div>
                        </div>
                        <div class="col-lg-3" style="padding: 0px">
                            <template v-if="formData.p7_overall_rating_not_applicable">
                                <div style="height: 100%; display: flex; justify-content: center; align-items: center;" class="odoo-cell-grey">N/A</div>
                            </template>
                            <template v-else="">
                                <div style="height: 100%; display: flex; flex-direction:column; text-align:center; justify-content: center; align-items: center;" class="odoo-cell-grey">
                        ...
                        <small class="text-muted">Note: I the rating provided above does not apply in the case of this employee. you may select the 'Not Applicable' option.</small>
                    </div>
                </form>
            </div>
        </div>
    ...
    // <input type="number" min="0" max="5" step=0.1 class="form-control" placeholder="Rating if applicable" :disabled="readOnlyMode || formData.p7_overall_rating_not_applicable" v-model="formData.p7_overall_rating" name="p7_overall_rating" id="p7_overall_rating" />

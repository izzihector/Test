FieldMEmployeeFeedback = {
    ...
    methods: {
        onChangeQ1(e) {
            this.formData.field_p2_q1_training_type = ''
        },
        ...
        writeDataToForm(data) {
            ...
            this.formData['has_sup_fieldstaff_employee_feedback'] = true
            this.formData['field_p2_q1'] = data.value['field_p2_q1']
            this.formData['field_p2_q1_training_type'] = data.value['field_p2_q1_training_type']
            this.formData['field_p2_q2'] = data.value['field_p2_q2']
            this.formData['field_p2_q3'] = data.value['field_p2_q3']
            this.formData['field_p2_emp_comments'] = data.value['field_p2_emp_comments']
        },
        async submitForm() {
            ...
            if (result) {
                ...
                if (this.appraisalData.value.metaInfo.field_staff_employee_feedback_state){
                    this.changeComponent('FieldMPerformanceRating')
                }
            }
    ...
    template: `
        <div>
            <h4 style="font-size: 20px;background: #ffffff;padding: 10px 0;margin-top: 20px;border-bottom: 4px solid #875a7b;text-transform: uppercase;">
                Employee feedback (Capacity development and feedback about supervision)
            </h4>
                    ...
                    <div class="row" style="font-size: 15px">
                        <div class="p-0">
                            <div class="row bg-white">
                                ...
                                <div class="col-lg-5 border-grey border py-1 px-2">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" @change="onChangeQ1($event)" id="question1a" name="question1" value="yes" v-model="formData.field_p2_q1" :disabled="readOnlyMode">
                                        <label class="custom-control-label" for="question1a">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input" @change="onChangeQ1($event)" id="question1b" name="question1" value="no" v-model="formData.field_p2_q1" :disabled="readOnlyMode">
                                        <label class="custom-control-label" for="question1b">No</label>
                                    </div>
                                    <br/>
                                    <span v-show="formData.field_p2_q1 == 'yes'">
                                        <label for="" class="font-weight-normal mt-1">Type Of Training:</label>
                                        <input type="text" class="form-control" placeholder="Type of Training..." v-model="formData.field_p2_q1_training_type" :disabled="readOnlyMode"/>
                                    </span>                           
                                </div>
                            </div>
                            <div class="row bg-white">
                                ...
                                <div class="col-lg-5 border-grey border py-1 px-2">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input"  id="question1c" name="question1c" value="yes" v-model="formData.field_p2_q2" :disabled="readOnlyMode">
                                        <label class="custom-control-label" for="question1c">Yes</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" class="custom-control-input"  id="question1d" name="question1c" value="no" v-model="formData.field_p2_q2" :disabled="readOnlyMode">
                                        <label class="custom-control-label" for="question1d">No</label>
                                    </div>                     
                                </div>
                            </div>
                            <label for="field_p2_q3" class="font-weight-normal question-text w-100 mt-3">What training opportunities and support does the employee request for the next review period?</label>
                            <textarea id="field_p2_q3" class="form-control" rows="3" placeholder="Your answer here..." v-model="formData.field_p2_q3" :disabled="readOnlyMode"></textarea>
                            <label for="field_p2_emp_comments" class="font-weight-normal question-text w-100 mt-3">Employees Comments on his performance, Training and support accorded by supervisor during the review period:</label>
                            <textarea id="field_p2_emp_comments" class="form-control" rows="4" placeholder="Your comments here..." v-model="formData.field_p2_emp_comments" :disabled="readOnlyMode"></textarea>
                        </div>
                    </div>
                </form>
            </div>    
